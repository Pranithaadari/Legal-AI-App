...
load_dotenv(r"C:\Users\Ammulu\OneDrive\Desktop\infosys\in.env")
...
SERVICE_ACCOUNT_FILE = "legal-doc-449015-456b16bcef2f.json"  # Replace with your Google Sheet service access .json file for your account
SPREADSHEET_ID = "1hBn9puxi_YUqx4lHZJa-aAp6wqfuw_P5AgCyYPmwkTc"  # Replace with your Google Sheet ID
...
#sender_password = st.sidebar.text_input("Sender Password", placeholder="Enter sender password...", type="password")
...
if uploaded_file:
    ...
    if file_content:
        ...
        try:
            # If the tenant and database are not set properly, initialize with default values
            chroma_client = chromadb.Client()  # Ensure this client is properly initialized
            vector_store = Chroma.from_texts(texts, embed, client=chroma_client)  # Pass the client to the vector store
        ...
        if st.button("Get Response") and 'vector_store' in locals():
...
#GROQ_API_KEY="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"
